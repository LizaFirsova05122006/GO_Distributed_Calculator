...
<ol>
  <li>Templates - папка с шаблонами:</li>
  <ul>
  ...
  <li>Main.go - файл, в котором написана главная программа сервера</li>
  <li>Шаблоны страниц:</li>
  <ul>
    <li>Calculate.html</li>
    <li>Login.html</li>
    <li>Postform.html</li>
    <li>Register.html</li>
    <li>Rezult.html</li>
  ...
  <li>Requirements.txt - файл с описанием необходимых библиотек</li>
</ol>
<br></br>
